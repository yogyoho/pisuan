...
const rememberRemoteSource = (source) => {
  ...
  localStorage.setItem('pisuan_remote_repo_history', JSON.stringify(history))
}
...
const loadHistory = () => {
  try {
    const raw = localStorage.getItem('pisuan_remote_repo_history')
    if (raw) {
...
const deleteHistoryItem = (item) => {
  ...
  localStorage.setItem('pisuan_remote_repo_history', JSON.stringify(repoHistory.value))
}

const clearAllHistory = () => {
  repoHistory.value = []
  localStorage.removeItem('pisuan_remote_repo_history')
