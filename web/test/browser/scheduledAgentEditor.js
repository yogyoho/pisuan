...
async (page) => {
  ...
  await page.screenshot({ path: '/tmp/pisuan-schedule-light.png' })
  await page.evaluate(() => document.documentElement.classList.add('dark'))
  await page.screenshot({ path: '/tmp/pisuan-schedule-dark.png' })
  ...
  await page.screenshot({ path: '/tmp/pisuan-schedule-narrow.png' })
