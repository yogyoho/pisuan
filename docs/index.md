---
# 自定义官网式首页，内容见 .vitepress/theme/components/PisuanHome.vue
layout: home
title: Pisuan · 让知识真正参与每一次行动
description: 可私有部署的多租户知识智能体平台，统一知识库、知识图谱、多智能体执行、MCP/Skills、沙盒与权限管理。
---

## 项目定位

EAI-FLow不是单一的问答页面，而是一个面向开发者与团队的 AI 应用平台。它把知识库、知识图谱和智能体开发放在同一套系统里，适合从原型验证一路走到团队内部落地。
