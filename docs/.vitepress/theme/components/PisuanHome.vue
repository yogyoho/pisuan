...
const OSS_ASSET_BASE = 'https://xerrors.oss-cn-shanghai.aliyuncs.com/github/pisuan/docs/home'
const MASCOT_IMAGE = `${OSS_ASSET_BASE}/pisuan-mascot-cutout.png`
    ...
    <section class="yx-hero">
      <div class="yx-shell yx-hero__grid">
        <div class="yx-hero__copy">
          <div class="yx-lockup">
            <img
              ...
              :src="withBase('/home/pisuan-lockup-on-light.svg')"
              alt="Pisuan"
              width="240"
              height="79"
            >
            <img
              ...
              :src="withBase('/home/pisuan-lockup-on-dark.svg')"
              alt="Pisuan"
              width="240"
              height="79"
            >
        ...
        <div class="yx-hero__visual">
          <figure class="pixel-mascot" role="img" aria-label="Pisuan 在循环流动的文档、知识图谱、记忆与交付信号中持续工作">
    ...
    <main>
      ...
      <section class="yx-section yx-flow">
        <div class="yx-shell">
          <header v-reveal class="yx-heading">
            <h2>一条完整的知识智能体链路</h2>
            <p>Pisuan 把知识、执行、交付和团队治理放在同一套可部署边界内。</p>
          </header>
          ...
          <div v-reveal class="yx-capabilities">
            <div class="yx-capabilities__intro">
              ...
              <a :href="withBase('/intro/project-overview')">认识 Pisuan <span aria-hidden="true">→</span></a>
            </div>
            <dl>
      ...
      <section class="yx-community">
        <div class="yx-shell yx-community__inner">
          ...
          <div v-reveal class="yx-community__footer">
            <div>
            <h2>继续探索，也欢迎一起构建</h2>
            <p>查看演示、提交 Issue，或从贡献指南开始参与 Pisuan。</p>
            </div>
