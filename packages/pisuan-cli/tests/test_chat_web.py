...
import pytest
import pisuan_cli.chat_web as chat_web_module
from rich.console import Console
from pisuan_cli.chat_web import ChatWebError, ChatWebServer, _browser_events, run_web_chat
    ...
    try:
        ...
        connection.request(
            ...
            headers={
                ...
                "X-Pisuan-Chat-Token": "session-secret",
            },
        )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"X-Pisuan-Chat-Token": "wrong-token"}, "会话令牌无效"),
    ],
)
...
def test_run_web_chat_opens_browser_and_closes_resources(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(chat_web_module, "PisuanClient", FakeClient)
