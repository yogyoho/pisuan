...
async def test_list_chapter_keys_uses_graph_first():
    from pisuan.agents.toolkits.buildin.tools import list_chapter_keys
    with patch("pisuan.services.graph_query_service.GraphQueryService") as MockSvc:
...
async def test_list_chapter_keys_falls_back_to_db():
    from pisuan.agents.toolkits.buildin import tools as tools_mod
    with patch("pisuan.services.graph_query_service.GraphQueryService") as MockSvc, \
...
async def test_get_chapter_outline_uses_graph_first():
    from pisuan.agents.toolkits.buildin.tools import get_chapter_outline
    graph_data = {
...
async def test_get_templates_uses_graph_first():
    from pisuan.agents.toolkits.buildin.tools import get_templates
    graph_templates = [
