...
from pisuan.storage.postgres.models_domain_entity import DomainEntitySchema, ReportType
from pisuan.storage.postgres.models_domain_factory import DomainFactoryDomain
