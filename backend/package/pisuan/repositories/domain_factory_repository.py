...
class DomainFactoryRepository:
    ...
    async def count_committed_tasks(self, domain_code: str) -> int:
        ...
        from pisuan.storage.postgres.models_domain_factory import DomainFactoryDomain, DomainFactoryTask
    ...
    async def upsert_outline(
        ...
        *,
        ...
        from pisuan.storage.postgres.models_domain_factory import DomainFactoryOutline
    ...
    async def backfill_template_chapter_key(
        ...
        from pisuan.storage.postgres.models_domain_factory import DomainFactoryLearnedTemplate
