...
from pisuan.utils.datetime_utils import duration_ms, format_utc_datetime, utc_now_naive
...
class Message(Base):
    ...
    started_at = Column(DateTime, nullable=True, comment="Pisuan 观察到操作开始的 wall-clock 时间")
    finished_at = Column(DateTime, nullable=True, comment="Pisuan 观察到操作结束的 wall-clock 时间")
