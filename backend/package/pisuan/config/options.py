...
from pisuan.storage.redis import get_async_redis_client
from pisuan.utils.logging_config import logger

OPTION_CACHE_PREFIX = "pisuan:config_option:"
OPTION_CACHE_VERSION_PREFIX = "pisuan:config_option_version:"
...
def normalize_option_value(field: dict[str, Any], value: Any) -> Any:
    ...
    if field.get("type") == "ocr_engine" and normalized:
        from pisuan.knowledge.parser.capabilities import get_ocr_engine_ids
