...
from pisuan.agents.context import BaseContext, prepare_agent_runtime_context
from pisuan.agents.skills.service import PERSONAL_SKILL_SOURCE_TYPE
...
from pisuan.storage.postgres.models_business import AgentRun, User
...
def resolve_code_revision() -> str | None:
    ...
    revision = os.getenv("PISUAN_CODE_REVISION", "").strip()
