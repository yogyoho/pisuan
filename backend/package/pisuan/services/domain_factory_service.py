...
from pisuan.services.entity_meta_service import EntityMetaAdapter, EntityMetaMatcher, SlotEntityMapper
...
class DomainFactoryService:
    ...
    async def _etl_pipeline_async(self, context) -> dict[str, Any]:
        ...
        try:
            ...
            from pisuan.knowledge.parser.unified import parse_source_to_markdown
...
如果没有明确的逻辑条件，condition 字段可以省略或设为 null。"""
    ...
    async def validate_task(self, task_id: str) -> dict[str, Any]:
        ...
        """
        from pisuan.services.pre_commit_validator import PreCommitValidator
        from pisuan.services.slot_validation_service import SlotValidationService
    ...
    async def _upload_original_to_minio(
        ...
        try:
            from pisuan.storage.minio import get_minio_client
            from pisuan.storage.minio.client import aupload_file_to_minio
    ...
    def _normalize_domain_for_graph(self, domain: str) -> str:
        ...
        from pisuan.repositories.domain_factory_repository import _normalize_domain
    ...
    def _normalize_report_type_for_graph(self, report_type: str) -> str:
        ...
        from pisuan.repositories.domain_factory_repository import _normalize_report_type
    ...
    async def _commit_pipeline_async(self, context) -> dict[str, Any]:
        ...
        try:
            ...
            if knowledge_base_id:
                try:
                    from pisuan.knowledge.runtime import knowledge_base as kb_manager
                    from pisuan.knowledge.base import FileStatus
...
"""
    ...
    async def _remap_waiting_review_tasks(self, domain_code: str) -> int:
        ...
        from pisuan.services.entity_meta_service import SlotEntityMapper
