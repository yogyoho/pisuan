...
from pisuan.utils.filepreview import PreviewResult
from pisuan.workspace.preview import preview_workspace_file
...
def _preview_response(result: PreviewResult) -> dict | StreamingResponse:
    ...
    return StreamingResponse(
        ...
        headers={
            ...
            "X-Pisuan-Preview-Type": result.preview_type,
