...
from pisuan.agents.tool_approval import DEFAULT_TOOL_APPROVAL_MODE, normalize_tool_approval_mode
...
from pisuan.services.langfuse_service import get_trace_url_by_id_async
...
from pisuan.storage.postgres.models_business import Message, User, build_agent_run_timing
...
from pisuan.utils.sse_utils import (
...
def _compact_run_event_envelope(envelope: dict) -> dict | None:
    ...
    if event_type == "metadata":
        ...
        return compact
    if event_type == "custom" and isinstance(payload, dict) and payload.get("name") == "pisuan.agent_state":
