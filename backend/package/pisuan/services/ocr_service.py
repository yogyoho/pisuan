...
from pisuan.knowledge.parser.capabilities import OCR_FILE_EXTENSIONS, PARSER_CAPABILITIES, get_parser_capability
from pisuan.knowledge.parser.factory import DocumentProcessorFactory
from pisuan.models.providers.service import get_model_provider_by_id, resolve_api_key
...
async def parse_document(
    ...
    不应直接调用 ``pisuan.knowledge.parser.unified`` 中的内部解析入口，否则会
    ...
    from pisuan.knowledge.parser.unified import parse_resolved_document
