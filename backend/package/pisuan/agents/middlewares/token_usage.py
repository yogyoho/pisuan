...
def _model_identity(request: ModelRequest, response: ModelResponse) -> dict[str, str]:
    ...
    for key, meta_key in (
        ("provider_id", "pisuan_provider_id"),
        ("provider_type", "pisuan_provider_type"),
        ("configured_model_id", "pisuan_model_id"),
        ("configured_model_spec", "pisuan_model_spec"),
    ):
