...
from pisuan.agents.backends.paths import VIRTUAL_PATH_PREFIX, VIRTUAL_PERSONAL_SKILLS_PATH
...
def _prepare_skill_from_sandbox(
    ...
    from pisuan.agents.skills.service import is_valid_skill_slug
...
async def _run_install_task(
    ...
    try:
        ...
        if source.startswith("/"):
            ...
            from pisuan.agents.skills.remote_install import prepare_remote_skills_batch
