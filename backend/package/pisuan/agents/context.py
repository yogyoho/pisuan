...
from pisuan.agents.tool_approval import DEFAULT_TOOL_APPROVAL_MODE
...
DEFAULT_PISUAN_SUMMARY_PROMPT = """你是对话上下文压缩助手。
...
class BaseContext:
    ...
    summary_prompt: str = field(
        default=DEFAULT_PISUAN_SUMMARY_PROMPT,
        metadata={
            "name": "上下文摘要提示词",
...
async def resolve_agent_resource_options(
    ...
    *,
    ...
    if "mcps" in fields_to_load:
        from pisuan.agents.mcp.service import get_all_mcp_servers, get_enabled_mcp_server_slugs
    ...
    if "skills" in fields_to_load:
        from pisuan.agents.skills.service import list_accessible_skills
...
async def prepare_agent_runtime_context(
    ...
    async with pg_manager.get_async_session_context() as db:
        ...
        from pisuan.agents.backends.knowledge_base_backend import resolve_visible_knowledge_bases_for_context
