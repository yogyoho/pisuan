...
from pisuan.knowledge.chunking.ragflow_like.presets import ensure_chunk_defaults_in_additional_params
from pisuan.knowledge.read_models import KnowledgeBaseConfig
from pisuan.knowledge.schemas import (
    FindOutputSchema,
    FindWindowSchema,
    SearchOutputSchema,
    SearchResultSchema,
)
from pisuan.knowledge.utils import resolve_processing_params, sanitize_processing_params
...
class KnowledgeBase(ABC):
    ...
    async def add_file_record(
        ...
        *,
        ...
        """
        from pisuan.knowledge.utils.kb_utils import prepare_item_metadata
