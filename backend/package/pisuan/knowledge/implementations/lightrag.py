...
from pisuan.knowledge.chunking.ragflow_like.presets import resolve_chunk_processing_params
from pisuan.models.embed import get_embedding_model_info_by_id
from pisuan.plugins.parser.unified import Parser
from pisuan.utils import hashstr, logger
...
class LightRagKB(KnowledgeBase):
    ...
    def _get_embedding_func(self, embed_info: dict):
        ...
        if config_dict.get("model_id") and config_dict["model_id"].startswith("ollama"):
            ...
            from pisuan.utils import get_docker_safe_url
    ...
    async def _ingest_structured_document(
        ...
        """
        from pisuan.services.domain_factory_service import build_embedding_text
