...
from pisuan.knowledge.parser.base import BaseDocumentProcessor
from pisuan.knowledge.parser.capabilities import PARSER_CAPABILITIES, get_parser_capability
