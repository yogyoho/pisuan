...
PARSER_CAPABILITIES = {
    "rapid_ocr": ParserCapability(
        ...
        module_path="pisuan.knowledge.parser.rapid_ocr",
    ...
    "mineru_ocr": ParserCapability(
        ...
        supported_extensions=_STANDARD_OCR_EXTENSIONS,
        module_path="pisuan.knowledge.parser.mineru",
    ...
    "mineru_official": ParserCapability(
        ...
        module_path="pisuan.knowledge.parser.mineru_official",
    ...
    "pp_structure_v3_ocr": ParserCapability(
        ...
        supported_extensions=_STANDARD_OCR_EXTENSIONS,
        module_path="pisuan.knowledge.parser.pp_structure_v3",
    ...
    "deepseek_ocr": ParserCapability(
        ...
        module_path="pisuan.knowledge.parser.deepseek_ocr",
    ...
    "paddleocr_vl_1_6": ParserCapability(
        ...
        supported_extensions=_STANDARD_OCR_EXTENSIONS,
        module_path="pisuan.knowledge.parser.paddleocr_api",
